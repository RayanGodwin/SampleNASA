...
protocol PlanetaryViewModeling
{
    ...
    func fetchItemOfTheDay(dateString: String,
                           modelDownloadCompletion: @escaping FetchCurrentItemOfDayDownloadCallback,
                           imageDownloadCompletion: @escaping FetchCurrentItemOfDayImageDownloadCallback)
}
...
class PlanetaryViewModel: PlanetaryViewModeling
{
                           ...
                           imageDownloadCompletion: @escaping FetchCurrentItemOfDayImageDownloadCallback)
    {
        ...
        self.networkManager.fetchAstronomyPictureOfTheDay(dateString: dateString) { [weak self] result in
