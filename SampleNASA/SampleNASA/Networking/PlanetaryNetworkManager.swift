...
{
    func fetchAstronomyPictureOfTheDay(completionBlock: @escaping FetchPictureOfTheDayCompletionBlock)
...
class PlanetaryNetworkManager: PlanetaryNetworkManagingProtocol
{
    ...
    final func fetchAstronomyPictureOfTheDay(completionBlock: @escaping FetchPictureOfTheDayCompletionBlock)
    {
        ...
        guard let urlRequest = self.urlCreator.buildURLForAstronomyPicturOfTheDay() else
        {
